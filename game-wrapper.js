// ===== Game Configuration =====
// Game configuration will be loaded from games.json (auto-generated by GitHub Actions)
let GAME_CONFIG = {};
...
async function loadGamesConfig() {
    try {
        ...
        if (!response.ok) {
            console.error('Failed to load games.json, using fallback config');
...
// Fallback configuration if games.json fails to load
...
async function init() {
    ...
    GAME_CONFIG = await loadGamesConfig();
    console.log('Loaded games:', Object.keys(GAME_CONFIG));
